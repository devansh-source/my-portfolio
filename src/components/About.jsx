  ...
  return (
    ...
    >
      <Tilt
        ...
        className="w-full"
      >
        <div className="w-full green-pink-gradient p-[1px] rounded-[20px] shadow-card transition-all duration-300 hover:shadow-[0_0_30px_rgb(var(--color-accent-rgb)/0.3)]">
  ...
  return (
    <>
      ...
      >
        ...
        <span className="text-accent font-semibold">MERN stack</span> and am
